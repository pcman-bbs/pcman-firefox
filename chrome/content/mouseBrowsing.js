...
MouseBrowsing.prototype={
    ...
    getCursorStyle: function(cursorState) {
        ...
        case 'normal':
            return 'auto';
        case 'back':
            return 'url(chrome://pcmanfx2/skin/cursor/back.png) 0 6,auto';
        case 'pageup':
            return 'url(chrome://pcmanfx2/skin/cursor/pageup.png) 6 0,auto';
        case 'pagedown':
            return 'url(chrome://pcmanfx2/skin/cursor/pagedown.png) 6 21,auto';
        case 'home':
            return 'url(chrome://pcmanfx2/skin/cursor/home.png) 0 0,auto';
        case 'end':
            return 'url(chrome://pcmanfx2/skin/cursor/end.png) 0 0,auto';
        case 'enter_list':
            return extended ? 'pointer' : 'url(chrome://pcmanfx2/skin/cursor/enter.png) 0 6,auto';
        case 'enter_menu':
            return 'auto';
        case 'prevpost':
            return 'url(chrome://pcmanfx2/skin/cursor/prevous.png) 6 0,auto';
        case 'nextpost':
            return 'url(chrome://pcmanfx2/skin/cursor/next.png) 6 0,auto';
        case 'firstpost':
            return 'url(chrome://pcmanfx2/skin/cursor/first.png) 0 0,auto';
        case 'lastpost_list':
            return 'url(chrome://pcmanfx2/skin/cursor/last.png) 0 0,auto';
        case 'lastpost_reading':
            return 'url(chrome://pcmanfx2/skin/cursor/last.png) 0 0,auto';
        case 'refreshpost':
            return 'url(chrome://pcmanfx2/skin/cursor/refresh.png) 0 0,auto';
        default:
            return 'default';
        }
    },
